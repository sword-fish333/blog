				...
				<div>
					<form action="AddNewPost.php" method="Post" enctype="multipart/form-data">
						<fieldset>
							...
							<div class="form-group">
							<label for="categoryselect"><span class="field_info">Category:</span></label>
						...
						?>
							...
							<div class="form-group">
								<label for="imageselect"><span class="field_info">Select Image:</span></label>
							...
							<input  class="btn btn-success btn-lg" type="Submit" name="Submit" value="Add new Post" style="margin-bottom: 40px;">
						</fieldset>
					</form>
				</div>
			</div>
